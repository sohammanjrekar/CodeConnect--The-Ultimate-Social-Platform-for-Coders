    ...
    <div className="mx-auto">
      ...
      <div className="flex items-center justify-between bg-white px-4 py-6">
        ...
        <div className="flex items-center">
          ...
          <img
            className="ml-6 h-9 w-9 rounded-full object-cover"
              ...
              <div className="px-4">
                ...
                <div className="mb-6 sm:w-1/2 rounded-lg bg-white p-6">
                  ...
                  {/* <p className="my-6 text-sm font-normal text-gray-500">
                    Hi, I'm Kotler Philips. I am a doctoral student at Harvard
              ...
              <div className="px-4">
                ...
                <div className="grid sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3">
                  <div className="mb-6 rounded-lg bg-white p-6">
                    ...
                    <div className="mt-6 flex items-center justify-between text-sm font-semibold text-gray-900">
                      <div className="flex">
                        ...
                        <span className="mr-1">30</span> Task
                      </div>
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="mb-6 rounded-lg bg-white p-6">
                    ...
                    <p className="my-6 text-sm font-normal text-gray-500">
                      Hi, I'm Antoine Griezmann. I'm an Android Developer at
                      Google company . . .
                    </p>
                    <div className="mt-6 flex items-center justify-between text-sm font-semibold text-gray-900">
                      <div className="flex">
                        ...
                        <span className="mr-1">25</span> Task
                      </div>
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="mb-6 rounded-lg bg-white p-6">
                    ...
                    <p className="my-6 text-sm font-normal text-gray-500">
                      Hi, I'm Richard Kyle. I'm Expreinced 2D Designer at
                      Miracle Hub. . .
                    </p>
                    <div className="mt-6 flex items-center justify-between text-sm font-semibold text-gray-900">
                      <div className="flex">
                        ...
                        <span className="mr-1">20</span> Task
                      </div>
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="mb-6 rounded-lg bg-white p-6">
                    ...
                    <p className="my-6 text-sm font-normal text-gray-500">
                      Hi, I'm Sam Joseph. I'm Backend Engineer at X. . .
                    </p>
                    <div className="mt-6 flex items-center justify-between text-sm font-semibold text-gray-900">
                      <div className="flex">
                        <svg
                        ...
                        <span className="mr-1">19</span> Task
                      </div>
                      <div className="flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
