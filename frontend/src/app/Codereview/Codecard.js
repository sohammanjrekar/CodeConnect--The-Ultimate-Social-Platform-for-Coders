...
const Codecard = () => {
  ...
  <div id="code-area" className="py-4 text-sm px-4 mt-1 text-white text-xl">
    <div className="mb-2 text-sm">
      ...
      <span className="text-blue-400">pluckDeep</span>{" "}
      ...
      <span className="text-purple-600">split</span>(
      <span className="text-blue-400">'.'</span>).
      <span className="text-purple-600">reduce</span>((
      <span className="text-blue-400">accum</span>,{" "}
      <span className="text-blue-400">key</span>){" "}
      <span className="text-green-400">=&gt;</span>{" "}
      <span className="text-purple-600">accum</span>[
      <span className="text-purple-600">key</span>],{" "}
      <span className="text-purple-600">obj</span>)
    </div>
    <div className="mb-2 text-sm">
      <span className="text-yellow-300">const</span>{" "}
      ...
      <span className="text-blue-400">fns</span>){" "}
      <span className="text-green-400">=&gt;</span>{" "}
      <span className="text-blue-400">res</span>{" "}
      <span className="text-green-400">=&gt;</span>{" "}
      <span className="text-purple-600">fns</span>.
      <span className="text-purple-600">reduce</span>((
      <span className="text-blue-400">accum</span>,{" "}
    ...
    <div className="mb-2 text-sm">
      <div className="sub-line">
        <span className="text-yellow-300">const</span>{" "}
        <span className="text-blue-400">unfold</span>{" "}
        <span className="text-green-400">=</span> (
        <span className="text-blue-400">f</span>,{" "}
        <span className="text-blue-400">seed</span>){" "}
        <span className="text-green-400">=&gt;</span> {"{"}
      </div>
      <div className="sub-line ml-8 text-sm">
        <span className="text-yellow-300">const</span>{" "}
      ...
      <div className="sub-line ml-16 text-sm">
        <span className="text-yellow-300">const</span>{" "}
        <span className="text-blue-400">res</span>{" "}
        <span className="text-green-400">=</span>{" "}
        <span className="text-purple-600">f</span>(
        <span className="text-purple-600">seed</span>)
      </div>
      <div className="sub-line ml-16 text-sm">
        ...
        <span className="text-purple-600">acc</span>.
        <span className="text-purple-600">concat</span>([
        <span className="text-purple-600">res</span>[
        <span className="text-red-600">0</span>]])) :{" "}
        <span className="text-purple-600">acc</span>
      </div>
      <div className="sub-line ml-8 text-sm">{"}"}</div>
      <div className="sub-line ml-8 text-sm">
        <span className="text-yellow-300">return</span>{" "}
        <span className="text-purple-600">go</span>(
        <span className="text-purple-600">f</span>,{" "}
      ...
      <div className="sub-line text-sm">{"}"}</div>
    </div>
  </div>
</div>
