...
const Page = ({ params }) => {
  ...
  const handleDislike = () => {
    ...
    axios.put(`http://127.0.0.1:8000/codereview/code-reviews/${id}/`, {
      ...snippet,
          ...
          <div class="mt-8 lg:-mx-6 lg:flex lg:items-center">
            ...
            <div class="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
              ...
              <div class="flex items-center mt-6">
                <img class="object-cover object-center w-20 h-20 rounded-full" src={`https://res.cloudinary.com/dp6odhftt/image/upload/v1713680848/User/${userData.avatar}`} alt="" />
                <div class="mx-4">
